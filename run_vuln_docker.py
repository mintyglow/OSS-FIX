...
def main() -> int:
    parser = argparse.ArgumentParser(description="Docker 模式运行多 Agent 漏洞修复流水线")
    ...
    parser.add_argument("--base-image", default="", help="基础 Docker 镜像名（默认用环境变量或 ubuntu:22.04）")
